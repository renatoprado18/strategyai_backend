...
from app.services.analysis.enhanced import generate_enhanced_analysis, validate_enhanced_analysis
from app.services.analysis.multistage import generate_multistage_analysis  # NEW: Multi-stage pipeline
from app.routes.auth import authenticate_user, get_current_user, RequireAuth
...
import app.services.data.perplexity as perplexity_service  # Need module for follow-up research
from app.services.intelligence.dashboard import generate_dashboard_intelligence  # NEW: FREE dashboard AI
from app.services.ai.editor import (  # NEW: AI-powered report editor
    generate_edit_suggestion,
    generate_edit_suggestion_streaming,
    apply_edit_to_json_path,
    extract_section_context,
)
from app.services.pdf_generator import generate_pdf_from_report  # PDF generation
from app.services.analysis.confidence_scorer import calculate_confidence_score  # AI confidence scoring
from app.services.ai.chat import send_chat_message, get_quick_prompts  # AI chat system
...
async def health_check():
    ...
    try:
        from app.core.database import count_submissions
